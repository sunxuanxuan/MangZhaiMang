...
public class XZTActivity extends AppCompatActivity {

    private Spinner xzt_spinner1,xzt_spinner2;
    private List<String> seatsArr = new ArrayList<>();
    private ImageView xzt_pre;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        init();
        setContentView(R.layout.xzt_layout);

        xzt_spinner1 = (Spinner)findViewById(R.id.xzt_spinner1);
        xzt_spinner2 = (Spinner)findViewById(R.id.xzt_spinner2);
        xzt_pre = (ImageView)findViewById(R.id.xzt_pre);
        ...
        xzt_spinner1.setAdapter(adapter);
        for(int i=1;i<50;i++){
        ...
        xzt_spinner2.setAdapter(adapter1);

        xzt_pre.setOnClickListener(new View.OnClickListener() {
            @Override
